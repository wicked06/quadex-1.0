...
<!-- content Area -->
        <div class="row justify-content-center" style="margin-top:10%; center; padding:0px; ">
...
<!-- start editing -->
        ...
        <div class="row">
            <div class="col-lg-10 col-lg-push-1" style="min-height: 100px; background-color:white;" id="load_questions">
...
<script type="text/javascript">
    ...
    function load_total_que() 
    {
        ...
        xmlhttp.onreadystatechange=function()
        {
            ...
            {
                window.document.getElementById("total_que").innerHTML=xmlhttp.responseText;
            }
